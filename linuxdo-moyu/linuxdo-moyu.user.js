...
// @version      1.2.5
// @description  Discourse / LINUX DO 论坛显示优化与功能增强，优雅摸鱼。支持高仿 Excel 摸鱼外观（腾讯文档矢量 / Microsoft Excel 切图主题）、隐藏头像/表情/图片、护眼/暗黑、高亮楼主、黑名单、关键字屏蔽、图片预览、自动翻页等
// @author       urzeye
// @license      MIT
...
(function () {
  ...
  // Excel 主题资源（移植自 NGA-BBS-Script，MIT；仅保留 tencent + office）
  ...
  class LinuxDoMoyu {
    ...
    applyBodyFlags() {
      const map = {
        ...
        [`${PREFIX}-hide-sidebar`]: this.normal.hideSidebar,
        ...
        [`${PREFIX}-excel`]: this.normal.excelMode,
        [`${PREFIX}-wide`]: this.normal.wideMode,
...
`;
                ...
                <div class="${PREFIX}-item">
                  ...
                  <div class="${PREFIX}-excel-inline-opts">
                    <div class="${PREFIX}-excel-inline-row">
                      ...
                      <label class="${PREFIX}-field" title="含顶栏导航与左侧分类/tag/板块侧栏">
                        <span>导航/侧栏</span>
  ...
  const ExcelMode = {
    ...
    onApply(script) {
      ...
      const cover = (script.advanced.excelTitle || '').trim();
      if (cover) document.title = cover;
